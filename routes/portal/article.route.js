...
ArticleRouter.get("/check-slug/:slug",checkPermission('check-slug'), checkSlugUniqueness);
// generate slug
ArticleRouter.post("/generate-slug",checkPermission('generate-slug'), generateSlug);
